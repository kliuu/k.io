...
$(function() {
  var bookmark = {
    data: [{
      name: '开发日志',
      link: 'https://docs.qq.com/doc/DSkJPSGFxamRGdU1h',
      box_shadow: '#F18033',
      icon: 'img/log.png',
    },{
      name: '个人主页',
      link: 'https://kliuu.gitee.io/hblog/',
      box_shadow: '#F18033',
      icon: 'img/blog.png',
    },{
      name: '学习笔记',
      ...
      name: '谢菲官网',
      link: 'https://students.sheffield.ac.uk/',
      box_shadow: '#F18033',
      icon: 'https://api2.mubu.com/v3/document_image/6f318b5f-9fad-4995-aa83-c07876102594-2539378.jpg',
    },{
      name: '课程页面',
      link: 'https://vle.shef.ac.uk/ultra/course',
      box_shadow: '#F18033',
      icon: 'img/timetable.png',
    },{
      name: 'Blackboard',
      link: 'https://vle.shef.ac.uk/ultra/stream',
      box_shadow: '#F18033',
      icon: 'https://api2.mubu.com/v3/document_image/3c1a67d5-075c-46eb-959e-78b8f8325d6a-2539378.jpg',
    },{
      name: '校园地图',
      link: 'https://ssid.sheffield.ac.uk/campus-map/',
      box_shadow: '#f3547a',
